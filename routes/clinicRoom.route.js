...
const { createClinicRoom, getAllClinicRooms, viewDetailClinicRoom, updateClinicRoom, listDoctor, assignDoctor, unssignDoctor, deleteClinicRoom } = require('../controllers/clinicRoom.controller');
